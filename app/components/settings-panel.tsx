  ...
  return (
    <div className="space-y-6 animate-in fade-in-50 duration-500">
      <div>
        ...
        <p className="text-muted-foreground">Manage your application preferences and wallet settings</p>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="mt-1 p-3 bg-muted rounded-lg font-mono text-sm break-all">{walletAddress}</div>
            </div>
            <Button
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current Solana network configuration</CardDescription>
          </CardHeader>
          <CardContent>
